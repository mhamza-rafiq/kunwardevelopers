...
const LeadershipPreview = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.from(imageRef.current, {
        opacity: 0, x: -60, duration: 1.2, ease: "power2.out",
      ...
      gsap.from(contentRef.current?.querySelectorAll(".reveal-item"), {
        opacity: 0, y: 40, duration: 1, stagger: 0.15, delay: 0.2, ease: "power2.out",
        scrollTrigger: { trigger: containerRef.current, start: "top 70%", toggleActions: "play none none none" },
      });
    }, containerRef);
  ...
  return (
    <section id="leadership" ref={containerRef} className="min-h-screen flex items-center py-24 bg-background relative overflow-hidden">
          ...
          <div ref={contentRef}>
            ...
            <blockquote className="reveal-item border-l-2 border-accent pl-8 my-10">
              <p className="font-serif text-xl md:text-2xl text-foreground/90 italic leading-relaxed">
                "Enterprise balanced with public responsibility, and long-term value over short-term gain."
              </p>
            </blockquote>

            <p className="reveal-item text-foreground/60 font-sans text-base leading-relaxed mb-10">
              At eighteen, he founded HKS International and introduced what became Pakistan's first Health Card initiative — later adopted by the Government as one of the country's largest public healthcare programs. As Vice Chairman, Board of Investment & Trade, KP, he leads institutional reform, investment facilitation, and represented Pakistan at Osaka Expo 2025.
            </p>
